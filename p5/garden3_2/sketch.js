let palettes = {
  ...
  Summer: ["gold", "tomato", "green", "dodgerblue","darkgreen"],
...
function setup() {
  ...
  toggleButton = createButton('Hide').id('toggle-button');
...
function drawFlower(x, y, styleType=null) {
  ...
  let size = random(maxSize * 0.5, maxSize);// maxSize 50%-100%
  ...
  drawingContext.shadowBlur = 0; // reset so UI text isn’t glowing
  pop();
}
